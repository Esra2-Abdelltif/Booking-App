...
class ExploreListView extends StatelessWidget{
  ...
  ExploreListView(
      { Key? key ,required this.callback, required this.hotelData,
        required this.animation,this.isShowDate : false,
                    ...
                    children: [
                      ...
                      Row( mainAxisAlignment : MainAxisAlignment.center,
                        ...
                        children: [
                          ...
                          SizedBox(width: 4,),
                          Icon(Icons.maps_ugc,size: 12,),
                          Text("${hotelData.dist.toStringAsFixed(1)}",
                          ),
