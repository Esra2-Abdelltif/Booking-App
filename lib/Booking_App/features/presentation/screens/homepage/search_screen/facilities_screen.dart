          ...
          appBar: AppBar(
            ...
            actions: [
             Padding(
               ...
               },child: Text("clear all",style: TextStyle(color: AppColors.blueColor),)),
             )
            ],
...
//textEditingController: searchController,
            ...
            .toString())),
              ...
              if (SearchCubit.get(context).searchHotelsModel != null)
                SliverList(
                  delegate: SliverChildListDelegate([
                    if ( SearchCubit.get(context).searchHotelsModel!.data!.data.isNotEmpty)
                      Expanded(
                        child: ListView.separated(
                              ...
                              onTap: () {
                                AppConstance.navigateTo(
                                  ...
                                  router: HotelDetails(
                                    ...
                                    hotelid: SearchCubit.get(context).searchHotelsModel!.data!.data[index].id,
                                    hotelName: SearchCubit.get(context).searchHotelsModel!.data!.data[index].name,
                                    longitude:SearchCubit.get(context).searchHotelsModel!.data!.data[index].longitude,
                                    latitude: SearchCubit.get(context).searchHotelsModel!.data!.data[index].latitude,
                                    adresse: SearchCubit.get(context).searchHotelsModel!.data!.data[index].address,
                                    description:SearchCubit.get(context).searchHotelsModel!.data!.data[index].description,
                                    price: SearchCubit.get(context).searchHotelsModel!.data!.data[index].price,
                                    rate:SearchCubit.get(context).searchHotelsModel!.data!.data[index].rate,
                                  ),
                                );
                              },
                              child: Padding(
                                        ...
                                        child: Image(
                                          image: NetworkImage(
                                              'http://api.mahmoudtaha.com/images/${
                                                  SearchCubit.get(context).searchHotelsModel!.data!.data[index].images[math.Random().nextInt(SearchCubit.get(context).searchHotelsModel!.data!.data[index].images.length)]}'),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Row(
                                          ...
                                          Expanded(
                                              child: Padding(
                                                ...
                                                child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        SearchCubit.get(context).searchHotelsModel!.data!.data[index].name,
                                                        overflow:
                                                        TextOverflow
                                                            .ellipsis,
                                                        style: TextStyle(
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            child: Text(
                                                              SearchCubit.get(context).searchHotelsModel!.data!.data[index].address,
                                                              overflow:
                                                              TextOverflow
                                                                  .ellipsis,
                                                              style: TextStyle(
                            ...
                            itemCount: SearchCubit.get(context).searchHotelsModel!.data!.data.length),
                      ),
                    if (SearchCubit.get(context).searchHotelsModel!.data!.data.isEmpty)
